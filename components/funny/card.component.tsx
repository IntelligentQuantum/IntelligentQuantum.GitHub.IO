const FunnyCard = (props: { fact: { title: string, description: string, type: string }}) =>
{
    ...
    if (props.fact.type === "football")
    {
        Image =
            <div className='funny__header--content__images--img hover'>
                <img className="one" src='/image/funny/Antoine_Griezmann.png' alt='Antoine Griezmann'/>
                <img className='two' src='/image/funny/Lionel_Messi.png' alt='Lionel Messi'/>
            </div>
    }
    else if (props.fact.type === "instagram")
    {
        Image =
            <div className='funny__header--content__images--img__instagram'>
                <img src='/image/funny/Instagram.png' alt='Instagram'/>
            </div>
    }
    else if (props.fact.type === "discord")
    {
        Image =
            <div className='funny__header--content__images--img__discord'>
                <img src='/image/funny/Discord.png' alt='Discord'/>
            </div>
    }
    else if (props.fact.type === "cod")
    {
        Image =
            <div className='funny__header--content__images--img hover'>
                <img className='one' src='/image/funny/Azur.png' alt='Azur'/>
                <img className="two" src='/image/funny/Ghost_Reckoner.png' alt='Ghost Reckoner'/>
            </div>
    }
    else if (props.fact.type === "music")
    {
        Image =
            <div className='funny__header--content__images--img hover'>
                <img className="three" src='/image/funny/Shadmehr_Aghili.png' alt='Shadmehr Aghili'/>
            </div>
    }
    else if (props.fact.type === "guitar")
    {
        Image =
            <div className='funny__header--content__images--img hover'>
                <img className="four" src='/image/funny/Guitar.png' alt='Guitar'/>
            </div>
    }
    else if (props.fact.type === "space")
    {
        Image =
            <div className='funny__header--content__images--img hover'>
                <img className="four" src='/image/funny/Astronaut.png' alt='Astronaut'/>
            </div>
    }
