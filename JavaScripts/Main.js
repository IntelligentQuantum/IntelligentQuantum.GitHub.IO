...
// Slider
let recommendationsCount = document.querySelector('.home__recommendations').childElementCount;
document.querySelector('.home__recommendations').style.gridTemplateColumns = `repeat(${recommendationsCount}, minmax(30rem, 1fr))`;
