...
import { AsideToggle } from "../../Utils/Utils.service";
import Profile from '../../Assets/Images/im-parsa.png';
        ...
        <nav className="aside z-index__101">
            ...
            <div className="aside__information">
                ...
                <div className="aside__information--cv uppercase">
                    <a href={`/document/parsa_firoozi_cv-${Language}.pdf`} rel="noreferrer" target="_blank">
