...
const TooltipPrimary = (props: { title?: string | number, interactive?: boolean, placement?: 'top' | 'bottom' | 'left' | 'right', render?: ReactElement, light?: boolean, children: ReactElement }) =>
{
    const stylesConfig =
        {
            tension: 300,
